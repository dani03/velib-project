...
<body class="bg-gradient-to-r from-green-100" >
    ...
    <header class="flex justify-center align-text-bottom text-3xl mt-4">
        <h4>ajouter une station</h4>
    </header>
    ...
    <div class="w-full flex justify-center">
        <form action="{{ route('store.velib') }}" class="w-full max-w-lg mt-16 align-center">
            @csrf
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        id="grid-first-name" name="ville" type="text" placeholder="Nom de la station">
                </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-2">
                <div class="w-full px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        id="grid-city" type="text" name="commune" placeholder="Commune">
                </div>
